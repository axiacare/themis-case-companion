...
import { useAdminAuth } from "@/contexts/AdminAuthContext"; // AJUSTAR: caminho do seu contexto
              ...
              <div className="mt-6 pt-6 border-t">
                <div className="text-center">
                  <div className="flex items-center justify-center space-x-2 text-sm text-muted-foreground">
                    ...
                    {/* CONFIGURAR: Ajuste o nome da sua empresa */}
                    <span>Acesso exclusivo para administradores [SUA EMPRESA]</span>
                  </div>
                </div>
              </div>
            </CardContent>
